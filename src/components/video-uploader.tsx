  ...
  return (
    <div className="flex flex-col" style={{ height: '100dvh', background: 'var(--cream)' }}>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Cover — petit, centrat, visible sencer */}
        <div className="flex flex-col items-center py-5 px-5" style={{ background: 'var(--cream)', borderBottom: '1px solid var(--brown-100)' }}>
          <div className="relative rounded-2xl overflow-hidden"
            style={{ width: '62%', maxWidth: 240, aspectRatio: '4/5', background: '#111', boxShadow: '0 4px 24px rgba(0,0,0,0.18)' }}>
            {coverSrc
          ...
          >
            ...
            <span className="text-[13px] font-semibold">Editar portada</span>
          </button>
        </div>

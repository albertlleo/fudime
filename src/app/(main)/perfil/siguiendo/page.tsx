    ...
    <div className="min-h-dvh pb-20 overflow-y-auto" style={{ background: 'var(--cream)' }}>
      ...
      {following.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 px-8 text-center">
          ...
          <p className="font-semibold" style={{ color: 'var(--brown-900)' }}>Aún no sigues a nadie</p>
          <p className="text-sm mt-1" style={{ color: 'var(--brown-500)' }}>Explora el feed y sigue a los creadores que más te gusten</p>
          <Link href="/chefs"
            className="mt-4 px-5 py-2.5 font-semibold rounded-xl text-sm text-black"

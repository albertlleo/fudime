  ...
  return (
    <div className="min-h-dvh pb-16 overflow-y-auto">
      <div className="px-4 pt-12 pb-4 flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-stone-900">Seguidores <span className="text-stone-400 font-normal text-base">({followers.length})</span></h1>
      </div>

      {followers.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 px-8 text-center">
          <span className="text-4xl mb-3">👥</span>
          <p className="text-stone-900 font-semibold">Aún no tienes seguidores</p>
          <p className="text-stone-400 text-sm mt-1">Publica recetas para que la gente te descubra</p>
        </div>
      ) : (

...
export default function ConsumerProfile({
  ...
  return (
    <div className="min-h-dvh pb-28 overflow-y-auto" style={{ background: 'var(--cream)' }}>
      ...
      {/* Top bar: nom a l'esquerra, botons a la dreta */}
      ...
      <div className="px-5 pb-5 flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <span className="text-sm block" style={{ color: 'var(--brown-400)' }}>
            @{user.username ?? user.display_name}
          </span>
          <Link href="/perfil/editar"
            className="inline-flex items-center gap-1.5 mt-2 px-3 py-1.5 rounded-xl text-xs font-semibold transition-colors active:opacity-70"
